...
public class ProductController {
    ...
    public ResponseEntity<Object> getOneProducts (
        @PathVariable(value="id")
        UUID id
    ) {
        Optional<ProductModel> isProduct = productRepository.findById(id);
    ...
    public ResponseEntity<Object> updateProducts (
        ...
        var productToUpdate = isProduct.get();
